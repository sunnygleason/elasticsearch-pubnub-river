...
package org.elasticsearch.plugin.pubnub.river;

import org.elasticsearch.common.inject.Inject;
import org.elasticsearch.plugins.AbstractPlugin;
import org.elasticsearch.pubnub.river.PubNubRiverModule;
import org.elasticsearch.river.RiversModule;

/**
 *
 */
public class PubNubRiverPlugin extends AbstractPlugin {
  @Inject
  public PubNubRiverPlugin() {}
  ...
  public String description() {
    return "River PubNub Plugin";
  }

  public void onModule(RiversModule module) {
    module.registerRiver("pubnub", PubNubRiverModule.class);
  }
}
